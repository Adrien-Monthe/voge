...
@section('page-title', __('clubs.edit-club-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('clubs.edit-club-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('clubs.edit-club-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ $club->reference }}</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST"
                              action="{{ route('clubs.update', [app()->getLocale(), $club->id ])  }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="town" class="form-control" name="town" id="town" value="{{ $club->town }}">
                            </div>
