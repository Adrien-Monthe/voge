...
@section('page-title', __('contacts.show-contact-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('contacts.show-contact-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('contacts.show-contact-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('contacts.show-contact-title')</h5>
