                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST"
                              action="{{ route('pcategories.update', [app()->getLocale(), $pcategory->id])  }}">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description_en" class="form-control" id="description_en" cols="30"
                                          rows="3">{{$pcategory->getTranslation('description', 'en')}}</textarea>
                            </div>
                            <div class="col-12">
                                ...
                                <textarea name="description_fr" class="form-control" id="description_fr" cols="30"
                                          rows="3">{{$pcategory->getTranslation('description', 'fr')}}</textarea>
                            </div>
