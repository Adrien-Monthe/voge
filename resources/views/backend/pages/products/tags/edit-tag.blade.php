                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST"
                              action="{{ route('ptags.update', [app()->getLocale(), $ptag->id])  }}">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description_fr" class="form-control" id="description_fr" cols="30"
                                          rows="3">{{$ptag->getTranslation('description', 'fr')}}</textarea>
                            </div>
