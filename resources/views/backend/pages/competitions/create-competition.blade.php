...
@section('page-title', __('competitions.create-competition-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('competitions.create-competition-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('competitions.create-competition-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('competitions.create-competition-title')</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST"
                              action="{{ route('competitions.store', app()->getLocale())  }}"
