...
@section('page-title', __('admins.edit-admin-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('admins.edit-admin-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('admins.edit-admin-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('admins.edit-admin-title')</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST"
                              action="{{ route('admins.update', [app()->getLocale(), $admin->id])  }}"
