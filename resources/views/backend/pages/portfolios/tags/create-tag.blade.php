...
@section('page-title', __('potags.create-potag-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('potags.create-potag-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('potags.create-potag-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('potags.create-potag-title')</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST" action="{{ route('potags.store', app()->getLocale())  }}">
