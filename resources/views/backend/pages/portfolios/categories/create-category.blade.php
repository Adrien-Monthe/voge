...
@section('page-title', __('pocategories.create-pocategory-title'))

@section('content')
    <div class="pagetitle">
        <h1>@lang('pocategories.create-pocategory-title')</h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('pocategories.create-pocategory-title')</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('pocategories.create-pocategory-title')</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" method="POST"
                              action="{{ route('pocategories.store', app()->getLocale())  }}"
